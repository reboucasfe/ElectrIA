  ...
  return (
    <div className="container mx-auto p-8 max-w-3xl">
      ...
      <div className="prose prose-lg max-w-none">
        <p>Bem-vindo à EletroProposta IA! Ao acessar e utilizar nossa plataforma, você concorda em cumprir e estar vinculado aos seguintes termos e condições de uso. Por favor, leia-os atentamente.</p>

        <h2>1. Aceitação dos Termos</h2>
        <p>Ao criar uma conta, acessar ou usar qualquer parte da EletroProposta IA, você concorda com estes Termos de Uso e com nossa Política de Privacidade. Se você não concordar com qualquer parte destes termos, não deverá usar nossa plataforma.</p>
        ...
        <ul>
          <li>Você deve ter pelo menos 18 anos para usar a EletroProposta IA.</li>
